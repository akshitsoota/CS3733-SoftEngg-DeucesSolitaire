...
public class DeucesDeckController extends SolitaireReleasedAdapter {
	...
	public DeucesDeckController(DeucesSolitaire deucesSolitaire, MultiDeck doubleDeck, Column wastePile) {
	...
	public void mousePressed(MouseEvent e) {
		...
		DealOneCardMove theMove = new DealOneCardMove(multiDeck, wastePile);
		// Attempt the move
